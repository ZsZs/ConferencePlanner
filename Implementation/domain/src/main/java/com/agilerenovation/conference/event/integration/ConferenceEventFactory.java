...
public class ConferenceEventFactory {
   ...
   public ConferenceSession createSession( String sessionName, String trackName, Integer startsAt, Integer endsAt ) {
   ...
   public ConferenceSession createSession( String sessionName, ConferenceTrack track, Integer startsAt, Integer endsAt ) {
